...
/* package harkamalCheckers-0.1.0.0 */
#ifndef VERSION_harkamalCheckers
#define VERSION_harkamalCheckers "0.1.0.0"
#endif /* VERSION_harkamalCheckers */
#ifndef MIN_VERSION_harkamalCheckers
#define MIN_VERSION_harkamalCheckers(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_harkamalCheckers */
...
#define CURRENT_COMPONENT_ID "harkamalCheckers-0.1.0.0-DoEmdo8dlSyDY5M28bIceB-harkamalCheckers"
