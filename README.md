...
You should start by making a directory and running cabal init.
...
``` yaml
    ...
    main-is:             Main.hs
    hs-source-dirs: src -- if you want to use a source directory, otherwise leave this commented out
...
### A note on sharing your checkers game
